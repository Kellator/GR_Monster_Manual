            ...
            >
                ...
                <div style={{
                    ...
                    <p>
                        ...
                        Just enter <span style={{textDecoration: "underline"}}>UNDEAD</span> into the search bar for IoC and you'll get a list of creatures you can choose from!
                    </p><br/>
                    <p>
                        Originally designed for the plot team of a Michigan based LARP.
                    </p>
                    <p>
                        If you're ready to test out the <span style={{fontWeight: "bolder"}}>Codex Creatura</span>, click below.  Feel free to create your own user credentials or use the demo.  View existing creatures or create your own.
                    </p>
                </div>
                <Grid
                    item 
